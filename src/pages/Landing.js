...
const Landing = () => {
  return (
    <div className="min-vh-100 d-flex flex-column overflow-hidden">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="hero-content">
                <h1 className="display-4 fw-bold mb-4 text-gradient-primary">Welcome to MediSys Patient Monitoring</h1>
      ...
      {/* Features Section */}
      <section id="features" className="py-5 bg-light position-relative overflow-hidden">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="h1 fw-bold text-gradient-primary">Powerful Features</h2>
            <p className="lead text-muted" style={{ fontSize: '1.1rem' }}>Everything you need to monitor patient health effectively</p>
          </div>
          <div className="row g-4">
            <div className="col-md-4">
              <div className="feature-card text-center p-4 bg-white rounded-15 shadow-lg hover-lift">
                <div className="feature-icon mb-3">
                  <i className="bi bi-speedometer2" style={{ fontSize: '3rem' }}></i>
                </div>
                <h4 className="h5 fw-bold text-gradient-primary">Real-time Monitoring</h4>
                <p className="text-muted" style={{ fontSize: '0.95rem' }}>Track vital signs continuously with instant updates and notifications.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="feature-card text-center p-4 bg-white rounded-15 shadow-lg hover-lift">
                ...
                <h4 className="h5 fw-bold text-gradient-primary">Smart Alerts</h4>
                <p className="text-muted" style={{ fontSize: '0.95rem' }}>Get notified immediately when vital signs fall outside normal ranges.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="feature-card text-center p-4 bg-white rounded-15 shadow-lg hover-lift">
                ...
                <h4 className="h5 fw-bold text-gradient-primary">Advanced Analytics</h4>
                <p className="text-muted" style={{ fontSize: '0.95rem' }}>Comprehensive data analysis and trend visualization for better insights.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-md-3 col-6">
              <div className="stat-card text-center bg-white rounded-15 shadow-lg hover-lift">
        ...
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-md-2 col-4 text-center">
              <div className="tech-icon mb-3 bg-white rounded-15 shadow-lg hover-lift">
